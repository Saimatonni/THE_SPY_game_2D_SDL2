...
public:
	...
	SDL_Texture* woodback, *greenBack, *Instructions, *background, *background2, *playButton, *scoreButton, *instructionsButton, *exitButton, *continueButton, *arrowIndicator, *gameTitle;
	...
	SDL_Texture *shootInstruction, *jumpInstruction, *pauseInstruction, *backIns;
	...
	SDL_Rect forScoreButton, forPlayButton, forInstuctionButton, forContinueButton, forExitButton, totalScreen, forArrowIndicator, backgroundSrcRect, forGameTitle, forScoreBack;
